  ...
  render() {
    if (this.props.location.pathname === '/favorites' && this.props.user.favorites) {
      ...
      return favorites.map((movie) => {
        return <MovieCard key={movie.movie_id} movie={movie} handleFavorite={this.handleFavorite} handleDelete={this.handleDelete}/>
      })
    ...
    return this.props.movies.map((movie) => {
      return (
        <MovieCard key={movie.movie_id} movie={movie} handleFavorite={this.handleFavorite} user={this.props.user} handleDelete={this.handleDelete} />
      )
    })
  }
